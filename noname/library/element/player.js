...
${body}
  ...
  *iterableGetGainableCards(player, arg1, arg2) {
   ...
   */
  randomDiscard() {
    let position = "he", discarder = this, num = 1, random = false, log = "popup";
  ...
  modedDiscard() {
    ...
    next.setContent(async function(event2, trigger, player) {
  ...
  directgain(cards, broadcast, gaintag) {
    ...
    if (broadcast !== false) {
      game.broadcast(
        function(player, cards2) {
          player.directgain(cards2);
        },
        this,
        cards
      );
